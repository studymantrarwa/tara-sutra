...
module.exports=async(req,res)=>{try{
 ...
 if(req.method==='GET'){
  ...
  if(requestedId && requestedId!==u.id){
   ...
   const online=!!a.online&&!!a.last_seen&&(Date.now()-new Date(a.last_seen).getTime()<=75000);return json(res,200,{astrologer:{...a,online,full_name:profileRow?.full_name||'Astrologer',avatar_url:a.avatar_url||profileRow?.avatar_url||null,education:a.education||app[0]?.education||''}});
  }
